...
export const EventHandling = () => {
    ...
    return (
        ...
        <button onClick={(event) => handleButtonClick()}>click Me 2 </button>
        <br />
        {/* //? Inline Event Handlers */}
        <button onClick={(event) => console.log(event)}>Inline Function</button>
        <br />
        {/* //? Function Components with Inline Arrow Functions */}
        <button onClick={() => alert("Hey I am inline event function")}>Inline Arr fun
        </button>
        {/* {/* //? Passing Arguments to Event Handlers } */}
        {/* <button onClick={handleWelcomeUser}>click me</button> */}
        <button onClick={() =>handleWelcomeUser("md")}>click me</button>
        <button onClick={() =>handleWelcomeUser("ifaz")}>click me</button>
        </>
    );
};